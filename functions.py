...
class RNN(nn.Module):
    def __init__(self):
        ...
        self.lstm1 = nn.LSTM(input_size=690, hidden_size=512)
        self.lstm2 = nn.LSTM(input_size=512, hidden_size=256)
        self.lstm3 = nn.LSTM(input_size=256, hidden_size=128)
        self.lstm4 = nn.LSTM(input_size=128, hidden_size=64)
        self.lstm5 = nn.LSTM(input_size=64, hidden_size=32)
